...
if __name__=="__main__":
    ...
    for arch in archs:
        ...
        run_gts = []
        for run in runs:
            in_outputs = np.load("outputs/output_"+arch+'_CIFAR100_'+spar+'_'+str(run)+'.npy')
            gts = np.load('outputs/gts_'+arch+'_CIFAR100_'+spar+'_'+str(run)+'.npy')
        ...
        np.save('ada_ensem_output.npy', total_outputs)
        ...
        np.save('ada_ensem_target.npy', gt)
